...
// PolicyFunctionReconciler reconciles a PolicyFunction object
type PolicyFunctionReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *PolicyFunctionReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("policyfunction", req.NamespacedName)
...
func (r *PolicyFunctionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&rapidv1beta1.PolicyFunction{}).
		Complete(r)
}
